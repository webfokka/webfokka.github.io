...
document.querySelector('.contact__button').addEventListener('click', event => {
    if ( document.querySelectorAll('.contact__input')[0].value.length < 3 ) {
        document.querySelector('.contact__warning').textContent = '🔴 [ Укажите Ваш актуальный Telegram @username ] 🔴';
        ...
        document.querySelector('.contact__warning').textContent = '🟢 [ Заявка была успешно отправлена ] 🟢';
