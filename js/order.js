...
function sendMessageInTG() {
	...
	document.querySelector('.order__button').addEventListener('click', event => {
		...
		} else if ( document.querySelector('.order__input-email').value.length < 10 || !document.querySelector('.order__input-email').value.includes("@") || !document.querySelector('.order__input-email').value.includes(".") ) {
			document.querySelector('.order__message').textContent = 'Enter your e-mail';
			document.querySelector('.order__message').style.maxHeight = '60px';
			document.querySelector('.order__message').style.marginBottom = '20px';
			document.querySelector('.order__message').style.color = '#ff4a4a';
		...
		} else if ( document.querySelector('.order__country p').textContent == "Select from the list" ) {
      document.querySelector('.order__message').textContent = 'Select your country from the list';
			document.querySelector('.order__message').style.maxHeight = '60px';
			document.querySelector('.order__message').style.marginBottom = '20px';
			document.querySelector('.order__message').style.color = '#ff4a4a';
			document.querySelectorAll('.order__label p')[3].style.color = '#ff4a4a';
			document.querySelectorAll('.order__input')[3].style.background = "#ffc1c1";
      document.querySelector('.order__country').style.background = "#ffc1c1";
			setTimeout( () => {
        document.querySelector('.order__message').style.maxHeight = '0px';
				document.querySelector('.order__message').style.marginBottom = '0px';
				document.querySelectorAll('.order__label p')[3].style.color = '#000';
				document.querySelectorAll('.order__input')[3].style.background = "#fff";
        document.querySelector('.order__country').style.background = "#fff";
			}, 2000)
    } else if ( document.querySelector('.order__input-city').value.length < 3 ) {
			document.querySelector('.order__message').textContent = 'Enter your name city';
			document.querySelector('.order__message').style.maxHeight = '60px';
			document.querySelector('.order__message').style.marginBottom = '20px';
			document.querySelector('.order__message').style.color = '#ff4a4a';
			document.querySelectorAll('.order__label p')[4].style.color = '#ff4a4a';
			// document.querySelectorAll('.order__input')[2].style.border = "1px solid rgb(255, 94, 94)";
			document.querySelectorAll('.order__input')[4].style.background = "#ffc1c1";
			setTimeout( () => {
				document.querySelector('.order__message').style.maxHeight = '0px';
				document.querySelector('.order__message').style.marginBottom = '0px';
				document.querySelectorAll('.order__label p')[4].style.color = '#000';
				// document.querySelectorAll('.order__input')[2].style.border = "1px solid #dcdcdc";
				document.querySelectorAll('.order__input')[4].style.background = "#fff";
			}, 2000)
		} else if ( document.querySelector('.order__input-zip').value.length < 3 ) {
			document.querySelector('.order__message').textContent = 'Enter your Postcode / ZIP';
			document.querySelector('.order__message').style.maxHeight = '60px';
			document.querySelector('.order__message').style.marginBottom = '20px';
			document.querySelector('.order__message').style.color = '#ff4a4a';
			document.querySelectorAll('.order__label p')[5].style.color = '#ff4a4a';
			// document.querySelectorAll('.order__input')[2].style.border = "1px solid rgb(255, 94, 94)";
			document.querySelectorAll('.order__input')[5].style.background = "#ffc1c1";
			setTimeout( () => {
				document.querySelector('.order__message').style.maxHeight = '0px';
				document.querySelector('.order__message').style.marginBottom = '0px';
				document.querySelectorAll('.order__label p')[5].style.color = '#000';
				// document.querySelectorAll('.order__input')[2].style.border = "1px solid #dcdcdc";
				document.querySelectorAll('.order__input')[5].style.background = "#fff";
			}, 2000)
		} else if ( document.querySelector('.order__input-address').value.length < 10 ) {
			document.querySelector('.order__message').textContent = 'Enter your full delivery address';
			document.querySelector('.order__message').style.maxHeight = '60px';
			document.querySelector('.order__message').style.marginBottom = '20px';
			document.querySelector('.order__message').style.color = '#ff4a4a';
			document.querySelectorAll('.order__label p')[6].style.color = '#ff4a4a';
			// document.querySelectorAll('.order__input')[2].style.border = "1px solid rgb(255, 94, 94)";
			document.querySelectorAll('.order__input')[6].style.background = "#ffc1c1";
			setTimeout( () => {
				document.querySelector('.order__message').style.maxHeight = '0px';
				document.querySelector('.order__message').style.marginBottom = '0px';
				document.querySelectorAll('.order__label p')[6].style.color = '#000';
				// document.querySelectorAll('.order__input')[2].style.border = "1px solid #dcdcdc";
				document.querySelectorAll('.order__input')[6].style.background = "#fff";
			}, 2000)
		} else {
      ...
      function extractPriceFromString(str) {
        ...
        return parseFloat(cleaned) || 0;
			...
			messageTg += `<b>✉️ E-Mail - </b>${document.querySelector('.order__input-email').value}\n`;
...
const listEl = document.querySelector(".order__list");
const searchInputF = document.querySelector(".order__search-input");
const countryOutput = document.querySelector(".order__country p");
...
function renderCountries(filter = "") {
  ...
  filtered.forEach(country => {
    ...
    if (country.code === activeCountryCode) {
      item.classList.add("order__item-active");
    }

    item.addEventListener("click", () => {
      setActiveCountry(country.code);
      document.querySelector('.order__window').style.display = "none";
    });
...
function setActiveCountry(code) {
  ...
  countryOutput.textContent = country.name;

  document.querySelectorAll(".order__item").forEach(el => {
    el.classList.toggle(
      "order__item-active",
...
document.querySelector('.order__country').addEventListener('click', event => {
  if ( openSearch == false ) {
    document.querySelector('.order__window').style.display = "block";
    openSearch = true;
  } else {
    document.querySelector('.order__window').style.display = "none";
    openSearch = false;
